...
// const STANDARD_DIMENSIONS = [32, 64, 128];
...
const STANDARD_DIMENSIONS = generateDimensionRange(32, 192, 32)
...
// const smallScaffolds = generateAllCombinations("LrgMed", [32, 64], 4);
// const largeScaffolds = generateAllCombinations("LrgMed", [128, 160, 192], 2);
...
// const generatedScaffolds = generateAllCombinations("LrgMed", generateDimensionRange(32, 192, 32), undefined, ALLOWED_ASPECT_RATIOS);
...
// Example: const explicitScaffoldSizes = generateCustomSizes("LrgMed", ["256x256"]);
...
// Example: { fileName: "Scaffold_LrgMed_Custom", size: "100x200", customProp: value }
...
export const ScaffoldLrgMedToGenerate: ScaffoldTemplate[] = [
  ...generatedScaffolds,
