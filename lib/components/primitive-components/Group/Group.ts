...
import { Group_doInitialPcbPlacementDesignRuleChecks } from "./Group_doInitialPcbPlacementDesignRuleChecks"
import {
  ...
  implements ISubcircuit
{
  ...
  doInitialPcbPlacementDesignRuleChecks() {
    ...
    while (ancestor) {
      if (ancestor.isSubcircuit) return
      ancestor = ancestor.parent
    }

    Group_doInitialPcbPlacementDesignRuleChecks(this)
  }
