...
// Variant 5: one fixed per section, alternating between chip and passive per section
test("SchematicSection manual placement: one fixed per section alternating chip/passive", async () => {
