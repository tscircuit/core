...
// Variant 2: passives are manually placed, chips are auto
test("SchematicSection manual placement: passives manually placed, chips auto", async () => {
  ...
  circuit.add(
    <board width="60mm" height="50mm" routingDisabled>
      ...
      {/* Power Supply section — C1 manually placed, chip/others auto */}
      <chip
        name="U1"
        footprint="soic8"
      ...
      {/* Microcontroller section — R2 manually placed, chip/others auto */}
      <chip
        name="U2"
        footprint="soic16"
        schSectionName="mcu"
      ...
      {/* Sensors section — C4 manually placed, chip/others auto */}
      <chip
        name="U3"
        footprint="soic8"
      ...
      {/* Communication section — C5 manually placed, chip/others auto */}
      <chip
        name="U4"
        footprint="soic8"
      ...
      {/* Output section — R6 manually placed, LEDs/others auto */}
      <led
        name="D1"
        color="red"
        footprint="led0603"
