...
// Variant 3: chips fixed in some sections, passives fixed in others
test("SchematicSection manual placement: chips fixed in some sections, passives in others", async () => {
  ...
  circuit.add(
    <board width="60mm" height="50mm" routingDisabled>
      ...
      {/* MCU: passives fixed (R2, R3), chip auto */}
      <chip
        name="U2"
        footprint="soic16"
        schSectionName="mcu"
