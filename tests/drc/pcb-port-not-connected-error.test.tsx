...
test("check each PCB port is connected", async () => {
  ...
  circuit.add(
    ...
    >
      ...
      <resistor name="R3" resistance="10k" footprint="0402" pcbX={10} pcbY={0} />
  ...
  expect(pcbPortNotConnectedErrors).toMatchInlineSnapshot(`
    [
      ...
      {
        "error_type": "pcb_port_not_connected_error",
        "message": "pcb_port_not_connected_error: Pcb ports [pcb_port_3, pcb_port_4] are not connected together through the same net.",
        "pcb_component_ids": [
          "pcb_component_1",
          "pcb_component_2",
        ],
