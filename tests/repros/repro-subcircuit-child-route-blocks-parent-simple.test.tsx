...
test("parent route should not cross a preserved child-subcircuit trace", async () => {
  ...
  nestedCircuit.add(
    ...
    >
      ...
      <pcbnotetext
        ...
        pcbY={7.4}
        fontSize={0.42}
        text="PARENT ROUTES AROUND CHILD COPPER"
      />
    </board>,
  )
  ...
  expect(parentPhase?.startSimpleRouteJson?.traces).toHaveLength(0)
  expect(nestedCircuit.db.pcb_trace.list()).toHaveLength(2)
