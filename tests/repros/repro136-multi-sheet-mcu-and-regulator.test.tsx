 ...
 * (a microcontroller on Sheet 1, a power regulator on Sheet 2). Each sheet
 * should render its own subcircuit independently, without the other sheet
 * affecting it.
 */
test("mcu and regulator on separate sheets render independently", async () => {
  ...
  circuit.add(
    <board routingDisabled>
      ...
      <PowerRegulator name="REG" schSheetName="Sheet 2" />
    </board>,
  )
