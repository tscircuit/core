...
test("platform routingDisabled allows separate traces with unique names", async () => {
  ...
  circuit.add(
    <board name="main" width="26mm" height="16mm">
      ...
      <trace name="other_signal" from=".R3 > .pin2" to=".R4 > .pin1" />
      <pcbnotetext
        text="Separate nets with different trace names"
        pcbY={6.5}
        fontSize={0.5}
      />
      <pcbnotetext
      ...
      />
      <pcbnotetext
        text="other_signal: R3.pin2 to R4.pin1"
        pcbY={-4.5}
        fontSize={0.4}
      />
      <pcbnotetext
        text="Platform preview: different trace names are allowed"
        pcbY={-6.5}
        fontSize={0.4}
      />
    </board>,
