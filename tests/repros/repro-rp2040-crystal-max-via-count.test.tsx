...
test.failing("RP2040 crystal traces honor their zero-via limit", async () => {
  ...
  circuit.add(
    <board width="22mm" height="27mm">
      ...
      <pcbnotetext
        text="REPRO: RP2040 CRYSTAL VIA LIMIT"
        pcbX={3}
        pcbY={11.5}
        fontSize={0.6}
        color="#f5c542"
      />
      <pcbnotetext
        text="XIN/XOUT NETS REQUIRE maxViaCount = 0"
        pcbX={3}
        pcbY={10.2}
        fontSize={0.45}
        color="#f5c542"
      />
      <pcbnotetext
        text="BUG: ROUTER INPUT DROPS THE VIA LIMIT"
        pcbX={3}
        pcbY={9.1}
        fontSize={0.45}
        color="#ff6b6b"
      />
      <pcbnotetext
        text="RESULT: DEFAULT ROUTE USES 2 VIAS"
        pcbX={3}
        pcbY={8}
        fontSize={0.45}
        color="#ff6b6b"
