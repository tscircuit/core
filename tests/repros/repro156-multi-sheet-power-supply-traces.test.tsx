 ...
 *
 * Each sheet declares its schematic sections inside `<schematicsheet>`, while
 * all normal components remain board-level siblings assigned with
 * `schSheetName` and `schSectionName`. This matches the established
 * schematic-sheet section tests and keeps groups/subcircuits out of the repro.
 */
test("repro156: sheet-assigned section members retain routed traces", async () => {
