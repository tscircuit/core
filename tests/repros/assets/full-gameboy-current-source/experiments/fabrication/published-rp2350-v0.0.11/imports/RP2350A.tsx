...
export const RP2350A = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      pinAttributes={{
        ...Object.fromEntries(
          Object.entries(pinLabels)
            .filter(([, labels]) => labels[0].startsWith("GPIO"))
            .map(([pin]) => [pin, { isGpio: true }]),
        ),
        pin1: { requiresPower: true, requiresVoltage: 3.3 },
        pin6: { requiresPower: true, requiresVoltage: 1.1 },
        pin11: { requiresPower: true, requiresVoltage: 3.3 },
        pin20: { requiresPower: true, requiresVoltage: 3.3 },
        pin23: { requiresPower: true, requiresVoltage: 1.1 },
        pin30: { requiresPower: true, requiresVoltage: 3.3 },
        pin38: { requiresPower: true, requiresVoltage: 3.3 },
        pin39: { requiresPower: true, requiresVoltage: 1.1 },
        pin44: { requiresPower: true, requiresVoltage: 3.3 },
        pin45: { requiresPower: true, requiresVoltage: 3.3 },
        pin46: { requiresPower: true, requiresVoltage: 3.3 },
        pin47: { requiresGround: true },
        pin48: { providesPower: true, mustBeConnected: true },
        pin49: { requiresPower: true, requiresVoltage: 3.3 },
        pin50: { mustBeConnected: true },
        pin53: { requiresPower: true, requiresVoltage: 3.3 },
        pin54: { requiresPower: true, requiresVoltage: 3.3 },
