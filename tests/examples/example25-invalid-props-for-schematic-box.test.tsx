      ...
      [
        {
          ...
          "message": "schematicbox Must provide either both \`width\` and \`height\`, or a non-empty \`overlay\` array.",
          "pcb_center": {
            "x": 0,
            "y": 0,
          },
        ...
        },
        {
          "component_name": undefined,
          "error_type": "source_failed_to_create_component_error",
          "message": "schematicbox Cannot provide both \`width\`/\`height\` and \`overlay\` at the same time.",
          "pcb_center": {
            "x": 0,
            "y": 0,
          },
