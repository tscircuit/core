...
test("Community templates > should support sparkfunmicromod_processor", async () => {
  ...
  circuit.add(<board template="community:sparkfunmicromod_processor" />)
  ...
  expect(boardJson?.width).toBe(22)
  expect(boardJson?.height).toBe(22)
