...
describe("getRelativeDirection", () => {
  ...
  test("handles massive negative coordinate offsets", () => {
    expect(getRelativeDirection({ x: -100000, y: -100000 }, { x: -50000, y: -100000 })).toBe("right")
    expect(getRelativeDirection({ x: -50000, y: -100000 }, { x: -100000, y: -100000 })).toBe("left")
    expect(getRelativeDirection({ x: -100000, y: -100000 }, { x: -100000, y: -50000 })).toBe("up")
    expect(getRelativeDirection({ x: -100000, y: -50000 }, { x: -100000, y: -100000 })).toBe("down")
  })
