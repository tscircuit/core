// A passive connector: VBUS direction is chosen by the containing circuit.
// Numerical pin1..pin16 are importer indices, NOT USB-C contact numbers.
// Use physical contact aliases (A6, A7, B6, B7, A5, B5, etc.) for connections.
// Genuine exact supplier footprint imported with tsci import C165948 --jlcpcb --use-exact-footprint
...
type HroUsbCPinAttributes = NonNullable<
  ChipProps<typeof HroUsbCPinLabels>["pinAttributes"]
>

export type HroUsbCProps = Omit<
  ChipProps<typeof HroUsbCPinLabels>,
  | "pinLabels"
  | "pinAttributes"
  | "footprint"
  | "supplierPartNumbers"
...
> & {
  pinAttributes?: Partial<HroUsbCPinAttributes>
}

export const HroUsbC = (props: HroUsbCProps) => {
  return (
    <connector
      {...props}
      pinLabels={HroUsbCPinLabels}
      pinAttributes={
        {
