...
type FerriteBeadProps = Omit<
  ChipProps<typeof pinLabels>,
  "pinLabels" | "footprint" | "supplierPartNumbers" | "manufacturerPartNumber"
>

// Murata BLM18SG121TN1D, JLCPCB C113030: 120 ohm at 100 MHz,
// 3 A, 25 milliohm maximum DCR. Exact JLCPCB-linked EasyEDA geometry
// imported with tsci on 2026-09-12.
export const BLM18SG121TN1D = (props: FerriteBeadProps) => (
  <chip
    {...props}
    pinLabels={pinLabels}
    supplierPartNumbers={{ jlcpcb: ["C113030"] }}
    manufacturerPartNumber="BLM18SG121TN1D"
    footprint={
      <footprint>
        <smtpad
          portHints={["pin1"]}
    ...
    cadModel={{
      objUrl:
        "https://modelcdn.tscircuit.com/easyeda_models/assets/C113030.obj?uuid=a7f84688c5004aa68dbcbddc99bd5473",
      stepUrl:
        "https://modelcdn.tscircuit.com/easyeda_models/assets/C113030.step?uuid=a7f84688c5004aa68dbcbddc99bd5473",
