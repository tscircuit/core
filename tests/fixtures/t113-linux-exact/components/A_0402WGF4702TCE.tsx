...
export const A_0402WGF4702TCE = (props: Omit<ResistorProps, "resistance">) => {
  ...
  return (
    <resistor
      ...
      manufacturerPartNumber="0402WGF4702TCE"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin2"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C25792.obj?uuid=026a4a15ab5c4a92ac0e421d6d013717",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C25792.step?uuid=026a4a15ab5c4a92ac0e421d6d013717",
        pcbRotationOffset: 0,
