...
export const CL05A474KP5NNNC = (props: Omit<CapacitorProps, "capacitance">) => {
  ...
  return (
    <capacitor
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C47339.obj?uuid=32fe2cf9314f444ca2785a33c2db7189",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C47339.step?uuid=32fe2cf9314f444ca2785a33c2db7189",
        pcbRotationOffset: 0,
