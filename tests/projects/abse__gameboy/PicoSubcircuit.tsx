...
const makeUniquePinLabels = (pins: string[]) =>
  pins.map((pin, index) =>
    pins.indexOf(pin) === index ? pin : `${pin}_${index + 1}`,
  )
...
export const PicoSubcircuit = (props: PicoSubcircuitProps) => (
  <subcircuit name="PICO" {...props}>
    ...
    />
    <trace
      name="J_RIGHT_V3V3_EN"
      from=".J_RIGHT > .V3V3_EN"
      to="net.V3V3_EN"
      schDisplayLabel="3V3_EN"
    />
    <trace
      name="J_RIGHT_ADC_VREF"
      from=".J_RIGHT > .ADC_VREF"
      to="net.ADC_VREF"
      {...adcRefLabel}
    />
    <trace
    ...
    <trace
      ...
      from=".U1 > .GPIO22"
      to=".J_RIGHT > .GP22"
      schDisplayLabel="GP22"
    />
    <trace
      {...denseTraceProps}
      name="GP26_ADC0"
      from=".U1 > .GPIO26_ADC0"
      to=".J_RIGHT > .GP26_ADC0"
      schDisplayLabel="GP26"
    />
    <trace
      {...denseTraceProps}
      name="GP27_ADC1"
      from=".U1 > .GPIO27_ADC1"
      to=".J_RIGHT > .GP27_ADC1"
      schDisplayLabel="GP27"
    />
    <trace
      {...denseTraceProps}
      name="GP28_ADC2"
      from=".U1 > .GPIO28_ADC2"
      to=".J_RIGHT > .GP28_ADC2"
      schDisplayLabel="GP28"
    />
