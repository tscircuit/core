...
const DisplaySilkscreen = () => (
  <>
    ...
    <silkscreenrect pcbX={activeAreaX} pcbY="0mm" width="57.6mm" height="43.2mm" />
    <silkscreentext text="{NAME}" pcbX="0mm" pcbY="24mm" anchorAlignment="center" fontSize="1mm" />
    <silkscreentext text="LCDWIKI 2.8 SPI ILI9341" pcbX="4mm" pcbY="-24mm" anchorAlignment="center" fontSize="1mm" />
  </>
)
