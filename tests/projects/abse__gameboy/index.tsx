...
export default () => (
  ...
  >
    ...
    <trace
      ...
      to=".PICO .J_RIGHT > .GP16"
    />
    <trace
      name="SPK_PWM"
      from=".PICO .J_LEFT > .GP12"
      to=".R_AMP_IN > .pin1"
      {...denseTraceProps}
    />
    <trace
    ...
    />
    <trace
      name="AMP_OUT_POS_RAW"
      from=".U_SPK_AMP > .OUT_L_POS"
      to=".FB_SPK_POS > .pin1"
      {...speakerTraceProps}
    />
    <trace
      name="AMP_OUT_POS_FILT"
      from=".FB_SPK_POS > .pin2"
      to=".J_SPK > .pin1"
      {...speakerTraceProps}
    />
    <trace
      name="AMP_OUT_POS_EMI"
      from=".FB_SPK_POS > .pin2"
    ...
    />
    <trace
      name="AMP_OUT_NEG_RAW"
      from=".U_SPK_AMP > .OUT_L_NEG"
      to=".FB_SPK_NEG > .pin1"
      {...speakerTraceProps}
    />
    <trace
      name="AMP_OUT_NEG_FILT"
      from=".FB_SPK_NEG > .pin2"
      to=".J_SPK > .pin2"
      {...speakerTraceProps}
    />
    <trace
      name="AMP_OUT_NEG_EMI"
      from=".FB_SPK_NEG > .pin2"
