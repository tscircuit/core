...
test("trace width with sequential-trace autorouter preset", async () => {
  const { circuit } = getTestFixture()

  circuit.add(
    <board width="15mm" height="15mm" autorouter="sequential-trace">
      <resistor
        name="R1"
        resistance="10k"
        footprint="0402"
  ...
  // Sequential-trace autorouter respects explicit trace thickness
  expect(
    pcbTrace.route
