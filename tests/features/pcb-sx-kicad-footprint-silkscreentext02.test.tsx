...
test("pcbSx kicad selector can customize silkscreen text position", async () => {
  ...
  circuit.add(
    ...
    >
      <pcbnotetext
        ...
        text="pcbSx: pcbX=1.5mm, pcbY=-2.25mm"
        fontSize={0.7}
      />
      <resistor
        name="R1"
  ...
  expect(kicadText?.anchor_position.x).toBeCloseTo(1.5)
  expect(kicadText?.anchor_position.y).toBeCloseTo(-2.25)
